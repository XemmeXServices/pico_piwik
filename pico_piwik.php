...
class Pico_Piwik {
	...
	public function build_piwik()
	{
		...
		$piscript .= '
			...
			(function() {
				var u=(("https:" == document.location.protocol) ? "https" : "http") + "://'.$this->piwik_domain.'/'.$this->piwik_folder.'/";
		...
		<noscript><p><img src="http://'.$this->piwik_domain.'/'.$this->piwik_folder.'/piwik.php?idsite='.$this->piwik_id.'" style="border:0;" alt="" /></p></noscript>
		';
		return $piscript;
	}
